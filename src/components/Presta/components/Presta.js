          ...
          <div className="container">
            ...
            <Grid>
              <Cell col={6} tablet={4} phone={4}>
                ...
                <div className="description-container">
                  <div className="description">
										{intl.messages['presta.frontEnd.content.first']}<span className="strong">{intl.messages['presta.frontEnd.content.second']}</span>{intl.messages['presta.frontEnd.content.third']}<span className="strong">{intl.messages['presta.frontEnd.content.fourth']}</span>.
                  </div>
                </div>
              </Cell>
              ...
              <Cell col={6} tablet={4} phone={4}>
                ...
                <div className="description-container">
                  <div className="description">
										{intl.messages['presta.backEnd.content.first']}<span className="strong">{intl.messages['presta.backEnd.content.second']}</span>{intl.messages['presta.backEnd.content.third']}<span className="strong">{intl.messages['presta.backEnd.content.fourth']}</span>!
									</div>
                </div>
              </Cell>
              ...
              <Cell col={6} tablet={4} phone={4} offsetDesktop={3}>
                ...
                <div className="description-container">
                  <div className="description">
                    {intl.messages['presta.automation.content.first']}<span className="strong">{intl.messages['presta.automation.content.second']}</span>!
                  </div>
                </div>
              </Cell>
            </Grid>
