export default [
  {
        ...
        description: {
            ...
            section: {
                title: "En bref...",
                content: "Après une phase de prototypage, Hollio m'a demandé de développer une API sécurisée en Node.js ainsi qu'un backoffice d'administration React.js afin d'intégrer sa solution d'analyse de propagation d'ondes."
            }
        }
    },
    {
    ...
    },
    {
        ...
        description: {
            client: {
                title: "Docker",
                content: "Docker est un logiciel libre qui automatise le déploiement d'applications dans des conteneurs logiciels. « Docker est un outil qui peut empaqueter une application et ses dépendances dans un conteneur isolé, qui pourra être exécuté sur n'importe quel serveur Linux » (Docker Inc.)"
            },
            section: {
                title: "En bref...",
    ...
    },
    {
        ...
        description: {
            client: {
                title: "ISEN - Adicode",
                content: "Les ADICODE® sont un dispositif d’accélérateur d’innovation et de formation pour les élèves-ingénieurs ISEN et les entreprises."
            },
            section: {
                title: "En bref...",
    ...
    },
    {
        ...
        description: {
            client: {
                title: "Decathlon",
                content: "Decathlon est un groupe français de grande distribution spécialisé dans les articles de sport et de loisirs."
            },
            section: {
                title: "En bref...",
